...
def calculate_market_share(cleaned_df, selected_brands=None):
    ...
    # Market Segment Grain: [year_week, clean_region, clean_therapeutic_area]
    segment_group = ['year_week', 'clean_region', 'clean_therapeutic_area']
    ...
    # Aggregate Total Segment Volume per (Year-Week, Region, Therapeutic Area)
    ...
    # Merge Segment Totals directly (no secondary left join needed)
